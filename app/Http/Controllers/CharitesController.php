...
class CharitesController extends Controller
{
    ...
    public function register_Beneficiaries(Request $req)
    {
        $validator = Validator::make($req->all(), [
            ...
            'total_need' => 'nullable|string',
            'duration' => 'required|in:30,90,182,365',
        ...
        $user->total_need = $data['total_need'];
    ...
    public function send_message(Request $request)
    {
        ...
        $type = new Messages();
        $type->message = $request->input('message');
        $type->user_id = $request->input('user_id');
        $type->charity_id = $request->input('charity_id');
        $type->Beneficiaries_id = $request->input('Beneficiaries_id');
